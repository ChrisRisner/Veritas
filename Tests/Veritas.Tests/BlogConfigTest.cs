...
namespace Veritas.Tests
{
    ...
    public class BlogConfigTest : TestBase
    {
        ...
        {            
            ...
            Assert.AreEqual(target.DefaultLogoUrl, "testlogo");
            ...
            Assert.AreEqual(target.GooglePlusUrl, "http://googleplus.com");
            ...
            Assert.AreEqual(target.UseTwitterCards, false);
        ...
        public void BuildXmlFromConfigTest()
        {
            ...
            target.DefaultLogoUrl = "testlogo";
            ...
            target.GooglePlusUrl = "http://googleplus.com";
